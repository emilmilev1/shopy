...
const ProductsPage: React.FC<ProductsPageProps> = ({
    ...
    const paginatedProducts = sortedProducts.slice(
        (pageNum - 1) * productsPerPage,
        pageNum * productsPerPage
    );
            ...
            {currentUser && (
                <Alert severity="info" sx={{ mb: 3 }}>
                    ...
                    <Typography variant="body2">
                        You are viewing your personal inventory. Each user can
                        only see and manage their own products.
                    </Typography>
                </Alert>
            )}
                        ...
                        {paginatedProducts.map((product) => (
                            <TableRow key={product.id.toString()} hover>
                                ...
                                <TableCell>
                                    ...
                                    typeof product.location.x === "number" &&
                                    typeof product.location.y === "number"
